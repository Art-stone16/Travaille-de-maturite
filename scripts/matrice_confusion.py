...
MATRIX_DIR = env_config.PROJECT_ROOT / "sorties" / "matrices_confusion"
...
# ====== Charger le modèle ======
model = keras.models.load_model(MODEL_DIR / MODEL_NAME / "best_model.keras")
...
plt.ylabel("Vrai")
plt.tight_layout()
plt.savefig(MATRIX_DIR / f"{MODEL_NAME}_confusion_matrix.png")
plt.show()
...
plt.ylabel("Vrai")
plt.tight_layout()
plt.savefig(MATRIX_DIR / f"{MODEL_NAME}_confusion_matrix_percent.png")
plt.show()
